...
using DockingUI.WinFormsUI.Docking.Win32;

namespace Cyclone.alg.win32
{
    internal static class NativeMethods
    {
        ...
        [DllImport("ntdll.dll")]
        public extern static IntPtr memcpy(
            IntPtr dst, IntPtr src, int count);

        [DllImport("ntdll.dll")]
        public extern static unsafe byte* memcpy(
            byte* dst, byte* src, int count);

        [DllImport("ntdll.dll")]
        public extern static IntPtr memset(
            IntPtr dst, int filler, int count);
